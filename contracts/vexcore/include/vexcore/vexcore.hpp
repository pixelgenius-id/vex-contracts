...
#include <vexcore/exchange_state.hpp>
#include <vexcore/native.hpp>
...
namespace eosiosystem {
  ...
  /**
   * The `vexcore` smart contract is provided by `block.one` as a sample system contract, and it defines the structures and actions needed for blockchain's core functionality.
   *
   * Just like in the `vex.bios` sample contract implementation, there are a few actions which are not implemented at the contract level (`newaccount`, `updateauth`, `deleteauth`, `linkauth`, `unlinkauth`, `canceldelay`, `onerror`, `setabi`, `setcode`), they are just declared in the contract so they will show in the contract's ABI and users will be able to push those actions to the chain via the account holding the `vexcore` contract, but the implementation is at the EOSIO core level. They are referred to as EOSIO native actions.
   *
   ...
   */
   ...
   struct [[eosio::table, eosio::contract("vexcore")]] name_bid {
     name            newname;
     name            high_bidder;
   ...
   struct [[eosio::table, eosio::contract("vexcore")]] bid_refund {
      name         bidder;
      asset        amount;
   ...
   struct [[eosio::table("global"), eosio::contract("vexcore")]] eosio_global_state : eosio::blockchain_parameters {
   ...
   struct [[eosio::table("global2"), eosio::contract("vexcore")]] eosio_global_state2 {
      eosio_global_state2(){}
   ...
   struct [[eosio::table("global3"), eosio::contract("vexcore")]] eosio_global_state3 {
      eosio_global_state3() { }
   ...
   struct [[eosio::table("global4"), eosio::contract("vexcore")]] eosio_global_state4 {
      eosio_global_state4() { }
   ...
   // Vexanium custom: daily withdraw/undelegate limits (migrated from old global4)
   struct [[eosio::table("vexlimits"), eosio::contract("vexcore")]] vex_limits_state {
      vex_limits_state() { }
      asset        daily_withdraw_limit;
      asset        daily_undelegate_limit;
      asset        total_withdrawn_today;
      asset        total_undelegated_today;
      time_point   last_reset_time;

      EOSLIB_SERIALIZE( vex_limits_state,
         (daily_withdraw_limit)(daily_undelegate_limit)
         (total_withdrawn_today)(total_undelegated_today)(last_reset_time) )
   };

   // Legacy struct matching old vexcore global4 binary layout — used only in migrate action
   struct eosio_global_state4_legacy {
      asset        daily_withdraw_limit;
      asset        daily_undelegate_limit;
      asset        total_withdrawn_today;
      asset        total_undelegated_today;
      ...
      EOSLIB_SERIALIZE( eosio_global_state4_legacy,
         (daily_withdraw_limit)(daily_undelegate_limit)
         (total_withdrawn_today)(total_undelegated_today)(last_reset_time) )
   };

   // Defines the schedule for pre-determined annual rate changes.
   struct [[eosio::table, eosio::contract("vexcore")]] schedules_info {
   ...
   struct [[eosio::table, eosio::contract("vexcore")]] producer_info {
      name                                                     owner;
      ...
      eosio::block_signing_authority get_producer_authority()const {
         if( producer_authority.has_value() ) {
            ...
            // zero_threshold could be true despite the validation done in regproducer2 because the v1.9.0 vexcore
   ...
   struct [[eosio::table, eosio::contract("vexcore")]] producer_info2 {
      name            owner;
   ...
   struct [[eosio::table("finkeys"), eosio::contract("vexcore")]] finalizer_key_info {
      ...
      // NOTE: BLS binary disabled on Spark503 — index by SHA256 of key string for unique lookup
      checksum256 by_fin_key()  const { return eosio::sha256(finalizer_key.data(), finalizer_key.size()); }
   ...
   struct [[eosio::table("finalizers"), eosio::contract("vexcore")]] finalizer_info {
   ...
   struct [[eosio::table("lastpropfins"), eosio::contract("vexcore")]] last_prop_finalizers_info {
   ...
   struct [[eosio::table("finkeyidgen"), eosio::contract("vexcore")]] fin_key_id_generator_info {
   ...
   struct [[eosio::table, eosio::contract("vexcore")]] voter_info {
   ...
   typedef eosio::singleton< "vexlimits"_n, vex_limits_state >  vex_limits_singleton;
   typedef eosio::singleton< "global4"_n, eosio_global_state4_legacy > global_state4_legacy_singleton;

   struct [[eosio::table, eosio::contract("vexcore")]] user_resources {
      name          owner;
      asset         net_weight;
      asset         cpu_weight;
      int64_t       ram_bytes = 0;
   ...
   struct [[eosio::table, eosio::contract("vexcore")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
   ...
   struct [[eosio::table, eosio::contract("vexcore")]] refund_request {
      name            owner;
   ...
   struct [[eosio::table,eosio::contract("vexcore")]] rex_pool {
      uint8_t    version = 0;
      asset      total_lent;
      asset      total_unlent;
      asset      total_rent;
   ...
   struct [[eosio::table,eosio::contract("vexcore")]] rex_return_pool {
      uint8_t        version = 0;
   ...
   struct [[eosio::table,eosio::contract("vexcore")]] rex_return_buckets {
      uint8_t                                version = 0;
   ...
   struct [[eosio::table,eosio::contract("vexcore")]] rex_fund {
      uint8_t version = 0;
      name    owner;
      asset   balance;
   ...
   struct [[eosio::table,eosio::contract("vexcore")]] rex_balance {
      uint8_t version = 0;
      name    owner;
      asset   vote_stake;
      asset   rex_balance;
   ...
   struct [[eosio::table,eosio::contract("vexcore")]] rex_loan {
      uint8_t             version = 0;
      name                from;
      name                receiver;
      asset               payment;
   ...
   struct [[eosio::table,eosio::contract("vexcore")]] rex_order {
      uint8_t             version = 0;
      name                owner;
      asset               rex_requested;
      asset               proceeds;
   ...
   struct [[eosio::table("rexmaturity"),eosio::contract("vexcore")]] rex_maturity {
   ...
   struct [[eosio::table("powup.state"),eosio::contract("vexcore")]] powerup_state {
   ...
   struct [[eosio::table("powup.order"),eosio::contract("vexcore")]] powerup_order {
      uint8_t              version = 0;
      uint64_t             id;
      name                 owner;
      int64_t              net_weight;
    ...
    */
   class [[eosio::contract("vexcore")]] system_contract : public native {
      ...
      private:
         ...
         vex_limits_singleton     _vexlimits;
         eosio_global_state       _gstate;
         eosio_global_state2      _gstate2;
         eosio_global_state3      _gstate3;
         eosio_global_state4      _gstate4;
         vex_limits_state         _gvexlimits;
      ...
      public:
         ...
         static constexpr eosio::name token_account{"vex.token"_n};
         static constexpr eosio::name ram_account{"vex.ram"_n};
         static constexpr eosio::name ramfee_account{"vex.ramfee"_n};
         static constexpr eosio::name stake_account{"vex.stake"_n};
         static constexpr eosio::name bpay_account{"vex.bpay"_n};
         static constexpr eosio::name vpay_account{"vex.vpay"_n};
         static constexpr eosio::name names_account{"vex.names"_n};
         static constexpr eosio::name saving_account{"vex.saving"_n};
         static constexpr eosio::name rex_account{"vex.rex"_n};
         static constexpr eosio::name fees_account{"vex.fees"_n};
         static constexpr eosio::name powerup_account{"vex.powup"_n};
         static constexpr eosio::name reserve_account{"vex.reserv"_n};
         static constexpr eosio::name null_account{"vex.null"_n};
         ...
         static symbol get_core_symbol( name system_account = "vexcore"_n ) {
         ...
         static bool rex_system_initialized( name system_account = "vexcore"_n ) {
         ...
         static bool rex_available( name system_account = "vexcore"_n ) {
            eosiosystem::rex_pool_table _rexpool( system_account, system_account.value );
         ...
         /**
          * Migrate action. One-time migration of old Vexanium global4 (daily limits)
          * to vexlimits table, and initialize new global4 with tokenomics defaults.
          * Must be called immediately after contract upgrade. Requires vexcore authority.
          */
         [[eosio::action]]
         void migrate();

         /**
          * Set daily withdraw limit from REX fund. Vexanium custom action.
          * @param limit - new daily withdrawal limit in core token
          */
         [[eosio::action]]
         void setrexlimit( const asset& new_limit );

         /**
          * Set daily undelegate bandwidth limit. Vexanium custom action.
          * @param new_limit - new daily undelegate limit in core token
          */
         [[eosio::action]]
         void setundlimit( const asset& new_limit );
          ...
          * which can transfer EOS tokens out of the account, acting as a proxy for vex.token::transfer.
          *
