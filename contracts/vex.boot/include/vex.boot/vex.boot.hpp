...
namespace eosioboot {
   ...
   /**
    * @defgroup eosioboot vex.boot
    * @ingroup eosiocontracts
    *
    * vex.boot is a extremely minimalistic system contract that only supports the native actions and an
    * activate action that allows activating desired protocol features prior to deploying a system contract
    * with more features such as vex.bios or vexcore.
    *
    * @{
    */
   class [[eosio::contract("vex.boot")]] boot : public eosio::contract {
      public:
   ...
   /** @}*/ // end of @defgroup eosioboot vex.boot
} /// namespace eosioboot
